FROM docker.elastic.co/kibana/kibana-oss:6.8.13
...
RUN bin/kibana-plugin install https://maven.search-guard.com/search-guard-kibana-plugin-release/com/floragunn/search-guard-kibana-plugin-6/${KIBANA_VERSION}-${SG_VERSION}/search-guard-kibana-plugin-6-${KIBANA_VERSION}-${SG_VERSION}.zip \
